...
export async function lockerRoutes(server) {
    ...
    const lockerController = new LockerController(createLockerUseCase, getLockersUseCase, getLockerByIdUseCase, deleteLockerUseCase, updateLockerUseCase);
