...
export async function paymentRoutes(server) {
    ...
    const paymentController = new PaymentController(createPaymentUseCase, getPaymentByIdUseCase, listPaymentsUseCase, updatePaymentUseCase, deletePaymentUseCase);
