...
export class EquipmentLoan {
    ...
    constructor(id, itemName, status, loanDate, dueDate, memberId, deletedAt) {
        this.id = id;
    ...
    static create(id, itemName, dueDate, memberId) {
        ...
        return new EquipmentLoan(id, itemName, EquipmentLoanStatus.Loaned, // Invariante 2: Estado inicial
        loanDate, dueDate, memberId, null // Invariante 3: No está eliminado
        );
    }
    // Actualiza los campos editables. Si el préstamo ya fue finalizado,
    // bloquea la edición de itemName y dueDate.
    updateInfo(itemName, dueDate) {
